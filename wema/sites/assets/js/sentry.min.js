    ...
    ***************************************************************************** */
    ...
    var Hub = /** @class */ (function () {
        ...
        Hub.prototype.getIntegration = function (integration) {
            ...
            try {
                ...
                IS_DEBUG_BUILD$1 && logger.warn("Cannot retrieve integration " + integration.id + " from the current Hub");
                return null;
            }
        };
        /**
        ...
        Hub.prototype._callExtensionMethod = function (method) {
            ...
            IS_DEBUG_BUILD$1 && logger.warn("Extension method " + method + " couldn't be found, doing nothing.");
        };
        return Hub;
    }());
    /**
    ...
    var BaseTransport = /** @class */ (function () {
        ...
        BaseTransport.prototype.recordLostEvent = function (reason, category) {
            ...
            IS_DEBUG_BUILD$3 && logger.log("Adding outcome: " + key);
        ...
        BaseTransport.prototype._flushOutcomes = function () {
            ...
            if (!Object.keys(outcomes).length) {
                IS_DEBUG_BUILD$3 && logger.log('No outcomes to flush');
                return;
            }
            IS_DEBUG_BUILD$3 && logger.log("Flushing outcomes:\n" + JSON.stringify(outcomes, null, 2));
            ...
            try {
                ...
                IS_DEBUG_BUILD$3 && logger.error(e);
            }
        };
        /**
    ...
    function injectReportDialog(options) {
        ...
        if (!options.eventId) {
            IS_DEBUG_BUILD$3 && logger.error('Missing eventId option in showReportDialog call');
            return;
        }
        if (!options.dsn) {
            IS_DEBUG_BUILD$3 && logger.error('Missing dsn option in showReportDialog call');
            return;
        }
    ...
    function globalHandlerLog(type) {
        IS_DEBUG_BUILD$3 && logger.log("Global Handler attached: " + type);
    }
        ...
        Dedupe.prototype.setupOnce = function (addGlobalEventProcessor, getCurrentHub) {
            addGlobalEventProcessor(function (currentEvent) {
                ...
                if (self) {
                    ...
                    try {
                        if (_shouldDropEvent$1(currentEvent, self._previousEvent)) {
                            IS_DEBUG_BUILD$3 && logger.warn('Event dropped due to being a duplicate of previously captured event.');
                            return null;
                        }
                    }
                    catch (_oO) {
    ...
    var BrowserClient = /** @class */ (function (_super) {
        ...
        BrowserClient.prototype.showReportDialog = function (options) {
            ...
            if (!this._isEnabled()) {
                IS_DEBUG_BUILD$3 && logger.error('Trying to call showReportDialog with Sentry Client disabled');
                return;
            }
    ...
    function startSessionTracking() {
        ...
        if (typeof document === 'undefined') {
            IS_DEBUG_BUILD$3 && logger.warn('Session tracking in non-browser environment with @sentry/browser is not supported.');
            return;
        }
        var hub = getCurrentHub();
